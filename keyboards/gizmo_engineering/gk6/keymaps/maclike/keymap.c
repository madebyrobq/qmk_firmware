...
// make gizmo_engineering/gk6:maclike
// (note: no "qmk" at the beginning of the command)
...
[QMK_LAYER] = LAYOUT_gk6_2x2u(
    ...
    KC_LSFT, XXXXXXX, XXXXXXX, CK_TOGG, XXXXXXX, RGB_VAI, RGB_SAI, RGB_MOD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
