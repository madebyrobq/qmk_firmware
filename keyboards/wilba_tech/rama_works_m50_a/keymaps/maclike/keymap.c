...
[DEFAULT_LAYER] = LAYOUT(
    ...
    KC_4,    KC_LCTL, KC_LALT, KC_LCMD, XXXXXXX, KC_SPC,     KC_SPC,        SPC_RSE, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT
),
...
//
[QMK_LAYER] = LAYOUT(
    _______, XXXXXXX, XXXXXXX,   TOWIN, XXXXXXX, QK_RBT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    _______, XXXXXXX,   TOMAC, S1_INC,  S2_INC,  EF_INC,  BR_INC,  H1_INC,  H2_INC,  ES_INC,  XXXXXXX, XXXXXXX, XXXXXXX,
    _______, KC_LSFT, XXXXXXX, S1_DEC,  S2_DEC,  EF_DEC,  BR_DEC,  H1_DEC,  H2_DEC,  ES_DEC,  XXXXXXX, XXXXXXX, XXXXXXX,
